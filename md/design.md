...
my-app/  
  assets/  
    colors\_and\_type.css     \# the §3 token block  
...
\`\`\`html  
\<link rel="stylesheet" href="assets/colors\_and\_type.css" /\>  
...
\- Use \*\*Inter\*\* \+ \*\*Hind Siliguri\*\* via \`google\_fonts\` package; bundle Noto Sans Bengali as asset font.  
...
\- \[ \] \`colors\_and\_type.css\` (or token block) imported?  
